...
Get rid of the first 100 frames to ignore early acute response to GF. This might bias the network to only look for it. Don't do it here, but while loading data for CNN training.
